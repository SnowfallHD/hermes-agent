...
def init_agent(
    ...
    agent._memory_provider_mode = "canonical"
    ...
    if not skip_memory:
        try:
            ...
            from agent.memory_policy import normalize_provider_mode
            agent._memory_provider_mode = normalize_provider_mode(
                mem_config.get("provider_mode", "canonical")
            )
