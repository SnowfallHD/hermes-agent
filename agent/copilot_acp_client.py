...
def _build_subprocess_env() -> dict[str, str]:
    ...
    # ACP CLIs such as GitHub Copilot keep auth material under the real OS-user
    # home. The generic terminal subprocess policy may intentionally redirect
    # HOME to {HERMES_HOME}/home for profile-isolated shell tools, but doing that
    # here makes Copilot look unauthenticated. Keep the sanitized env from the
    # central helper while forcing ACP children back to the resolved real home.
    env["HOME"] = home
