...
KANBAN_GUIDANCE = (
    ...
    "Do NOT block merely because you prepared a local/internal/draft-only artifact "
    "or an optional future external action exists. If your safe deliverable is done "
    "and you did not actually need permission to proceed, complete the task and note "
    "that publishing/outreach/spend/account/production actions were not performed.\n"
