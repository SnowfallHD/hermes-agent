...
class GatewayKanbanWatchersMixin:
    ...
    async def _kryden_linear_blocked_sync_watcher(self, interval: float = 3.0) -> None:
        ...
        script = hermes_home / "scripts" / "kryden_linear_blocked_sync.py"
        board = os.getenv("KRYDEN_LINEAR_KANBAN_BOARD", "kryden-50k-mrr")
        db_path = hermes_home / "kanban" / "boards" / board / "kanban.db"
        state_path = hermes_home / "kryden" / "linear_blocked_sync_watch_state.json"
