    ...
    for rel in _QUICK_STATE_FILES:
        ...
        if src.is_dir():
            ...
            for sub in src.rglob("*"):
                ...
                # prior board backups. Also skip heavy, regenerable per-board
                # subtrees (scratch workspaces and task attachments); we only
                # need board databases + metadata to restore a board.
                if rel == "kanban/boards":
                    if "archive" in sub_rel_path.parts:
                        continue
