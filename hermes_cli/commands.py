...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("viktor-status", "Show Kryden Viktor/Hermes decision-loop status", "Info",
               gateway_only=True, aliases=("viktor_status", "vstatus")),
...
_SLACK_PRIORITY_COMMANDS: tuple[str, ...] = ()
