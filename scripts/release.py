...
AUTHOR_MAP = {
    # Local Forklift merge commits are generated by SnowfallHD-maintained tooling.
    "forklift@example.invalid": "SnowfallHD",
    "SJWATTS89@OUTLOOK.COM": "lEWFkRAD",  # upstream salvage attribution
    "poli.koltsova@gmail.com": "wnuuee1",  # upstream salvage attribution
    ...
    "DavidMetcalfe@users.noreply.github.com": "DavidMetcalfe",  # PR #55086 salvage (desktop gateway statusbar tooltip)
    "christianpersico98@gmail.com": "chrispersico",  # PR #54862 salvage (docs web search instruction fix)
