...
AUTHOR_MAP = {
    ...
    "adalsteinni@gmail.com": "AIalliAI",  # PR #44159 (desktop hover-reveal trigger inset)
    "drmani215@gmail.com": "bionicbutterfly13",  # desktop backend port-squat/self-collision fix
    "evisolpxe@gmail.com": "Evisolpxe",  # desktop profile session read routing
    "kyssta69@gmail.com": "kyssta-exe",  # PRs #44446/#44518 (dashboard profile re-exec, cached-agent flush index)
